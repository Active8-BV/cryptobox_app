...
def print_pickle_variable_for_debugging(var, varname):
    ...
    :param varname:
    """
    print "cba_sync.py:747", varname + " = cPickle.loads(base64.decodestring(\"" + base64.encodestring(cPickle.dumps(var)).replace("\n", "") + "\"))"
    ...
    try:
        ...
        def prog_callback(param, current, total):
            ...
            try:
                ...
                print "cba_sync.py:924", "updating upload progress failed", str(exc)
