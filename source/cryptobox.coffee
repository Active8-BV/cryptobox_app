...
cryptobox_ctrl = ($scope, $q, memory, utils) ->
    ...
    start_after_second = =>
        ...
        try_get_sync_state()
        utils.set_interval("cryptobox.cf:666", second_interval, 1000, "second_interval")
