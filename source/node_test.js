...
var add_output, already_running, assert, cb_current, cb_done, child_process, exist, exist_string, fs, parse_json, pass, path, print, run_cba_main, strEndsWith, _,
  __slice = [].slice;
...
cb_done = function(r, o) {
  ...
  p = function(d) {
    return print("node_test.cf:167", d.message);
  };
  return _.each(o, p);
};

cb_current = function(o) {
  return print("node_test.cf:172", o);
};
