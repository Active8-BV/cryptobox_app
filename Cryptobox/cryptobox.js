...
update_sync_state = function(scope) {
  ...
  result_sync_state = function(result, output) {
    var ex, human_readable_size, human_readable_size2, sync_results;
    if (result) {
...
g_progress_callback = function(scope, output) {
  ...
  try {
    ...
    return print("cryptobox.cf:513", err);
  }
};
...
cryptobox_ctrl = function($scope, memory, utils, $q) {
  var digester, do_sync, once_motivation, progress_callback, ten_second_interval, two_second_interval;
  ...
  $scope.open_folder = function() {
    ...
    open_cb = function(result, output) {
      return print("cryptobox.cf:660", result, output);
    };
