...
run_command = function(name, data, scope) {
  var cmd_folder, cmd_path, error, ex, fout, result_cnt, result_path, second;
...
cryptobox_ctrl = function($scope, memory, utils) {
  var option, option_to_string, second_interval_scoped, set_data_user_config_once;
  ...
  option_to_string = function(option) {
    ...
    if (option.version != null) {
      return cmd_str += "-m " + option.version;
    }
  };
  return print("cryptobox.cf:647", option);
};
