...
run_cba_main = function(name, options, cb) {
...
cryptobox_ctrl = function($scope, memory, utils, $q) {
  ...
  $scope.sync_btn = function() {
    ...
    sync_cb = function(result, output) {
      ...
      if (result) {
        add_output("sync ok");
        return print("cryptobox.cf:559", output);
      }
    };
  ...
  $scope.encrypt_btn = function() {
    ...
    sync_cb = function(result, output) {
      ...
      if (result) {
        add_output("sync ok");
        return print("cryptobox.cf:576", output);
      }
    };
