      ...
      process_sync_result = function(sync_results) {
        ...
        if (sync_results.instruction != null) {
          ...
          try {
            ...
            return print("cryptobox.cf:451", sync_results);
          }
        }
      };
...
g_progress_callback = function(scope, output) {
  ...
  try {
    ...
    err = _error;
    return print("cryptobox.cf:584", "g_progress_callback", err);
  }
};
...
delete_blobs = function(scope) {
  ...
  cb_delete_blobs = function(result, output) {
    return print("cryptobox.cf:613", "blobs deleted", result, output);
  };
...
cryptobox_ctrl = function($scope, memory, utils, $q) {
  var check_feedback_progress_callback, digester, do_sync, once_motivation, progress_callback, ten_second_interval, two_second_interval;
  ...
  $scope.form_save = function() {
    ...
    get_user_var("cb_password", $q).then(function(oldpassword) {
      ...
      return print("cryptobox.cf:721", "error setting password", err);
    });
    $scope.form_changed = false;
  ...
  $scope.toggle_debug = function() {
    ...
    return print("cryptobox.cf:811", $scope.show_debug);
  };
