...
"use strict";
var BrowserDetect, GUID, asciistring, asciistring_lowercase, asciistring_lowercase_nospace, asciistring_no_specials, async_call, async_call_retries, b64_decode_mstyle, b64_encode_mstyle, b64_object_mstyle, b64_uri, b64mstyle, base64_decode, base64_encode, bool_parse, directive_check_slow_timeout, directive_check_timeout, emit_event, endswith, exist, exist_string, exist_truth, g_format_file_size, g_http_error, g_running_local, get_local_time, init_cryptobox, init_utils, instr, ismobile, load_save_object_cache, object_b64_mstyle, once_cb_init, once_load_save_object_cache, once_utils_init, other_with, param_unused, pass, pg, print, running_local, safe_b64, start_time, startswith, strcmp, translate, unique_number, uri_b64, warning,
  __slice = [].slice,
  _this = this,
...
angular.module("cryptoboxApp.base", []).factory("memory", function($q) {
  ...
  return {
    ...
    obj2b64: function(obj) {
      return this.b64_encode_mstyle(this.obj2json(obj));
    },
    b642obj: function(b64) {
      if (!String(b64).contains("mstyle")) {
        warning("app_basic.cf:1475", "b642obj", "mstyle not found in string");
        return b64;
      }
      return this.json2obj(this.b64_decode_mstyle(b64));
    },
