...
// TODO Move these definitions to pyi_global.h.
/* ## Definitions from Python's osdefs.h. ## */
/* Operating system dependencies */

/* Mod by chrish: QNX has WATCOM, but isn't DOS */
#if !defined(__QNX__)
#if defined(MS_WINDOWS) || defined(__BORLANDC__) || defined(__WATCORs__) || defined(__DJGPP__) || defined(PYOS_OS2)
